...
function DashboardUser() {
  ...
  function OpenModalForUser(index) {
    setOpenCitizen(true);
    setVariables({
  ...
  function UpdateUser(id){
    axios.get(`http://localhost:8080/user/update?id=${id}&firstName=${updateUser.firstName}&lastName=${updateUser.lastName}&email=${updateUser.email}&permission=${updateUser.permission}`)
  ...
  React.useEffect(() => {
    axios.get("http://localhost:8080/citizens/admin").then((response) => {
      ...
      <div>
        ...
        <main>
          <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <Transition.Root show={openCitizen} as={Fragment}>
              <Dialog
                as="div"
                className="fixed z-10 inset-0 overflow-y-auto"
                initialFocus={cancelButtonRef}
                onClose={setOpenCitizen}
              >
                      ...
                      <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div className="sm:flex sm:items-start">
                          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            />
                            <h2 className="text-xl font-semibold py-2">Δικαιοδοσία</h2>
                            ...
                            >
                              <option value="user">{updateUser.permission}</option>
